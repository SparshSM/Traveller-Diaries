...
function Home() {
  return (
    ...
    <div style={{position:""}}>
    <h3 className='texts' style={{position:"",fontFamily:"'Dancing Script','cursive'",fontWeight:"700",fontSize:"48px"}}>Let The Journey Begins,Give Your First Review Here</h3>
    </div>
  ...
  <div style={{display:"flex",justifyContent:"center"}}>
  <h3 style={{position:"relative",fontFamily:"'Dancing Script','cursive'",fontWeight:"700",fontSize:"48px"}}>Made Plans,Make Your Itienary Now With Diginotes</h3>
  </div>
  <div style={{display:"flex",justifyContent:"space-evenly"}}>
  <button className="buttonClass">Diginotes</button>
  </div>
    {/* <Carousel/> */}
    </div>
    </>
