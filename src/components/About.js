...
function About() {
  return (
  <>
   <section class="about_section layout_padding" style={{background:" linear-gradient(-45deg, #ee7752, #e73c7e, #23a6d5, #23d5ab)",height:"77.8vh"}}>
    <div class="container">
      <div class="heading_container" style={{padding:"100px"}}>
        <h2>
         Traveler Diaries
        </h2>
      </div>
        <div class="detail-box" style={{fontFamily:"Times New Roman"}}>
          <p>
